...
Jobs can be deleted using /deletejob, you can get the ID of the job you want to delete using /listjob. [TODO] If you want to stop a job without deleting its history of already-sent posts, use /pausejob. You can start it again using /resumejob.
